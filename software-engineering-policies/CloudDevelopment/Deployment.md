...
Its important to understand that the tooling doesnt have the necessary context around your implementation so can sometimes provide false positives, this may mean you will have a need to be excused from a issue. In these cases you can reach out to our [Cyber Security team](mailto:ukho-itso@ukho.gov.uk), your lead developer or one of the security champions for advice on mitigation/suppression of the issue. 
