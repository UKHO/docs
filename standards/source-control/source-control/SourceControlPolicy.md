...
Information about setting up your repository can be [found here](/standards/source-control/source-control/RepositorySetupPolicy.md)
...
Branch Protection should be setup against the main branch. Information is provided for [GitHub](/standards/source-control/source-control/GitBranchProtectionPolicy.md) and [Azure DevOps](/standards/source-control/source-control/AzDoBranchProtection.md)
