...
If we want to open source code we should use the [MIT license as per the policy](../../platform/open-source-contribution/OpenSourceContributionPolicy.md) (appendix A). This should assert Crown copyright, as per the example “Copyright (C) 2011 Crown copyright (United Kingdom Hydrographic Office)”).
