...
[Playwright](https://playwright.dev/) is our recommended browser automation tool, which MUST be used for all new test frameworks.  Cypress and Selenium code exists at the UKHO, but this should be considered legacy and may be replaced if the opportunity arises.
