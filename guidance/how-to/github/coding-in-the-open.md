...
In the case where a repository is available to be made open, it is required that a team lead fills in the [checklist](../../../policies/platform/open-source-contribution/OpenSourceGovernanceChecklist.md) with the necessary details. This request can then be processed in the development portal.
