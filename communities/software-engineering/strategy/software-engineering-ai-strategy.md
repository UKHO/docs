...
Refer to the [Code Generation Tools Policy](../../../policies/engineering/code-generation-tools/CodeGenerationToolsPolicy.md) for detailed organisational requirements on the use of code generation and AI-assisted development tools.
